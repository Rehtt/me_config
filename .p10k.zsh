# Generated by Powerlevel10k configuration wizard on 2025-06-03 at 10:17 CST.
...
() {
  ...
  function prompt_clamshell() {
   # 检测盖合状态（exit status 0 == 合盖）
   if ioreg -r -k AppleClamshellState -d 4 |
   ...
   # 输出段（-i 图标, -f 前景色, -t 文本；这里文本留空只显示图标）
   p10k segment -i $icon -f $color -t '屏幕'
  }
